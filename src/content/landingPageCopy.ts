...
export const landingPageCopy = {
  ...
  work: {
    ...
    card1Tag: pick(work, 'card_1_tag', 'Digital supply-chain'),
    card1TagType: pick(work, 'card_1_tag_type', 'Evaluative'),
    ...
    card2Tag: pick(work, 'card_2_tag', 'Digital supply-chain'),
    card2TagType: pick(work, 'card_2_tag_type', 'Enterprise dashboard'),
    ...
    card3Tag: pick(work, 'card_3_tag', 'Digital supply-chain'),
    card3TagType: pick(work, 'card_3_tag_type', 'Discovery'),
    ...
    cardCta: pick(work, 'card_cta', 'Read more →'),
  },
  about: {
  ...
  contact: {
    ...
    emailLabel: pick(contact, 'email', 'Email'),
